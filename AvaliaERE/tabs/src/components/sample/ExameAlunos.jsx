...
const questão1 = [
  ...
  "Factory, Iterador, Strategy",
  "Factory, Visitor, Strategy",
];
    ...
    return (
      <div>
        <div>
          <h2> Questão 1</h2>
          <div>
            <Text content={questão1[0]} size="medium" weight="none" />
          </div>
          <div>
            <Checkbox
    ...
    return (
      <div>
        <div>
          <h2> Questão 2</h2>
          <div>
            <Text content={questão2[0]} size="medium" weight="none" />
          </div>
          <div>
            <Checkbox
              onChange={() => this.mudarCheckbox(0)}
    ...
    return (
      <div>
        <div>
          <h2> Questão 3</h2>
          <div>
            <Text content={questão3[0]} size="medium" weight="none" />
          </div>
          <div>
            <Checkbox
              onChange={() => this.mudarCheckbox(0)}
